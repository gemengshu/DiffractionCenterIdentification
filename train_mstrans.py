...
from lca_pytorch import LCA_Unet
...
save_folder = 'paper_bce/'

test_image = Image.open('new_test/003_DIFF_20cm/003_DIFF_20cm_ori.jpg').convert('RGB') 
...
if pretrain:
    ...
    epochs = 5000
    lr = 1e-4
pretrain_path = 'paper_bce/model_epoch_{}.pth'.format(pretrain_num)
